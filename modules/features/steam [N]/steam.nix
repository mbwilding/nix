  ...
  flake.modules.homeManager.steam =
    ...
    in
    {
      ...
      home.file.".config/steamtinkerlaunch/default_template.conf".text = ''
        ...
        GAMESCOPE_ARGS="--nested-width 3840 --nested-height 2160 --output-width 3840 --output-height 2160 --nested-refresh 120 --nested-unfocused-refresh 120 --fullscreen --prefer-output HDMI-A-1,eDP-1 --prefer-vk-device --expose-wayland --backend wayland --hdr-enabled --adaptive-sync --rt --"
