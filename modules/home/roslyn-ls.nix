...
buildDotnetModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-NMRVFMxMxU8w561lWztD/P9lq3L4sQvlNR9ouUOcM60=";
  };
  ...
  meta = {
    ...
    description = "C# and Visual Basic language server (LSP) built on Roslyn";
    changelog = "https://github.com/dotnet/roslyn/releases/tag/v${finalAttrs.version}";
