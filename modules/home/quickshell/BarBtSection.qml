...
Item {
    ...
    Rectangle {
        ...
        // Width based on longest device name, with sane limits
        width: Math.round(260 * Config.scale)
        height: Math.min(
            btPopupCol.implicitHeight + Math.round(16 * Config.scale),
        ...
        Column {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            color: "white"
                            anchors.verticalCenter: parent.verticalCenter
                            x: (btSection.adapter && btSection.adapter.enabled)
            ...
            Item {
                width: btPopupCol.width
                height: Math.min(
                    btDevListCol.implicitHeight,
                    Math.round(400 * Config.scale)
                        - (btToggleRow.implicitHeight + Math.round(8 * Config.scale))
                ...
                Flickable {
                    ...
                    Column {
                        ...
                        Text {
                            ...
                            visible: !btSection.adapter
                                     || !btSection.adapter.devices
                                     || btSection.adapter.devices.count === 0
                        }
