...
in
{
  home = {
    ...
    file.".local/state/caelestia/scheme.json".text = builtins.toJSON {
      ...
      variant = "tonalspot";
      colours = {
        # gronk oil: OilFile=macro=#4eade5, OilLink=keyword=#6c95eb, interface=#9591ff
        ...
        onBackground = "bdbdbd";
        surface = "000000";
        # gronk: window_accent=#202020
        surfaceDim = "202020";
        # gronk: window_split=#404040
        surfaceBright = "404040";
        # gronk: window_bg=#101010
        ...
        # gronk oil: OilLink=keyword=#6c95eb (blue)
        secondary = "6c95eb";
        onSecondary = "000000";
        secondaryContainer = "6c95eb";
        onSecondaryContainer = "000000";
        # gronk: interface=#9591ff
        tertiary = "9591ff";
        onTertiary = "000000";
        ...
        # gronk oil: OilFile=macro=#4eade5
        primaryFixed = "4eade5";
        primaryFixedDim = "4eade5";
        onPrimaryFixed = "000000";
        onPrimaryFixedVariant = "000000";
        # gronk oil: OilLink=keyword=#6c95eb
        ...
        term14 = "5ABFB5";
        term15 = "B5BFE2";
        # gronk: variable=#edeecf
        rosewater = "edeecf";
        # gronk: enum=#e2bfff
        flamingo = "e2bfff";
        # gronk: number/attribute=#ed94c0
        pink = "ed94c0";
        # gronk: interface=#9591ff
        mauve = "9591ff";
        # gronk: attribute=#ed94c0
        red = "ed94c0";
        # gronk: module=#ffc794
        maroon = "ffc794";
        # gronk: warn/namespace=#ffb083
        peach = "ffb083";
        # gronk: string=#c9a26d
        yellow = "c9a26d";
        # gronk: comment=#85c46c
        green = "85c46c";
        # gronk: constant=#83f1ff
        teal = "83f1ff";
        sky = "83f1ff";
        # gronk: hint=#66c3cc
        sapphire = "66c3cc";
        # gronk: info/macro=#4eade5
        blue = "4eade5";
        # gronk: struct=#c191ff
        lavender = "c191ff";
        # gronk oil: OilFile=macro=#4eade5 (primary), OilLink=keyword=#6c95eb (secondary)
        klink = "4eade5";
