...
QtObject {
    ...
    readonly property QtObject bar: QtObject {
        ...
        readonly property var layout: [BarItems.tray, BarItems.separator, BarItems.system, BarItems.separator, BarItems.clock, BarItems.separator, BarItems.session, BarItems.pin]
