...
- Wifi in available is showing as 2.4 GHz for all but connected shows the actual one which is good, but sometimes it does show the correct one in the available list but rarely
